...
public class KeyHashUtils {
    ...
    public static String getKeyDigest(
            String keystoreStream, String keystorePassword, String alias, String type)
            throws Exception {
        if (Uri.parse(keystoreStream.toLowerCase())
                .getLastPathSegment()
                .substring(
                        (int)
                                (Uri.parse(keystoreStream.toLowerCase())
                                                .getLastPathSegment()
                                                .length()
                                        - ".".concat("jks").length()),
                        (int)
        ...
        } else if (Uri.parse(keystoreStream.toLowerCase())
                .getLastPathSegment()
                .substring(
                        (int)
                                (Uri.parse(keystoreStream.toLowerCase())
