...
public class BlurUtils {
    ...
    public static void applyBlurBehindDialog(
            Context context, AlertDialog dialog, float blurRadius) {
    ...
    private static void applyBlurFor12Plus(Context context, AlertDialog dialog, float blurRadius) {
        ...
        dialog.getWindow()
                .setBackgroundDrawable(new BitmapDrawable(context.getResources(), blurredBitmap));

        // Apply RenderEffect to the overlay
        overlay.setRenderEffect(
                RenderEffect.createBlurEffect(blurRadius, blurRadius, TileMode.DECAL));
    }
    ...
    private static Bitmap applyRenderEffect(Bitmap bitmap, float blurRadius) {
        ...
        RenderEffect renderEffect =
                RenderEffect.createBlurEffect(blurRadius, blurRadius, TileMode.CLAMP);
