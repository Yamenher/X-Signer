...
public class KeyCreatingActivity extends BaseActivity {
    ...
    private void initialize(Bundle _savedInstanceState) {
        ...
        CreateButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View _view) {
                        ...
                        if (!IsDetectedEmpty) {
                            if (KeyValidityE.getText().toString().trim().isEmpty()
                                    || (KeyValidityE.getText().toString().trim().length() > 3)) {
                        ...
                        if (!IsDetectedEmpty) {
                            if (CountryE.getText().toString().trim().isEmpty()
                                    || (CountryE.getText().toString().trim().length() > 2)) {
                        ...
                        if (!IsDetectedEmpty) {
                            ...
                            OutputPath =
                                    "/storage/emulated/0/X-Signer/Keys/"
                                            .concat(
                                                    NameE.getText()
                                                            .toString()
                                                            .trim()
                                                                                        ...
                                                                                        "Your"
                                                                                                .concat(
                                                                                                        extension
                                                                                                                .toUpperCase()
                                                                                                                .concat(
                                                                                                                        " keystore was successfully created and saved in path :\n"
                                                                                                                                .concat(
                                                                                                                                        OutputPath))),
                                                                                        "Finish",
                                                                                        1);
        ...
        KeyValidityE.addTextChangedListener(
                new TextWatcher() {
                    @Override
        ...
        CountryE.addTextChangedListener(
                new TextWatcher() {
                    @Override
                    public void onTextChanged(
                            CharSequence _param1, int _param2, int _param3, int _param4) {
                        ...
                        if (CountryE.getText().toString().length() > 2) {
                            CountryTIP.setError(
                                    "The country code must be formed from only 2 characters");
    ...
    private void initializeLogic() {
        ...
        KeyTypeE.setOnFocusChangeListener(
        ...
        KeySizeE.setOnFocusChangeListener(
                new View.OnFocusChangeListener() {
                    @Override
                    public void onFocusChange(View v, boolean hasFocus) {
                        if (hasFocus) {
        ...
        AliasE.setOnEditorActionListener(
        ...
        AliasPassE.setOnEditorActionListener(
                new TextView.OnEditorActionListener() {
                    @Override
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                        if (actionId == EditorInfo.IME_ACTION_NEXT) {
        ...
        KeyStorePassE.setOnEditorActionListener(
                new TextView.OnEditorActionListener() {
                    @Override
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                        if (actionId == EditorInfo.IME_ACTION_NEXT) {
        ...
        KeyTypeE.setOnEditorActionListener(
                new TextView.OnEditorActionListener() {
                    @Override
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                        if (actionId == EditorInfo.IME_ACTION_NEXT) {
        ...
        KeySizeE.setOnEditorActionListener(
                new TextView.OnEditorActionListener() {
                    @Override
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                        if (actionId == EditorInfo.IME_ACTION_NEXT) {
        ...
        KeyValidityE.setOnEditorActionListener(
                new TextView.OnEditorActionListener() {
                    @Override
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                        if (actionId == EditorInfo.IME_ACTION_NEXT) {
        ...
        NameE.setOnEditorActionListener(
                new TextView.OnEditorActionListener() {
                    @Override
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                        if (actionId == EditorInfo.IME_ACTION_NEXT) {
        ...
        OrUnitE.setOnEditorActionListener(
                new TextView.OnEditorActionListener() {
                    @Override
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                        if (actionId == EditorInfo.IME_ACTION_NEXT) {
        ...
        OrNameE.setOnEditorActionListener(
                new TextView.OnEditorActionListener() {
                    @Override
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                        if (actionId == EditorInfo.IME_ACTION_NEXT) {
        ...
        CityE.setOnEditorActionListener(
                new TextView.OnEditorActionListener() {
                    @Override
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                        if (actionId == EditorInfo.IME_ACTION_NEXT) {
        ...
        StateE.setOnEditorActionListener(
                new TextView.OnEditorActionListener() {
                    @Override
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                        if (actionId == EditorInfo.IME_ACTION_NEXT) {
        ...
        CountryE.setOnEditorActionListener(
                new TextView.OnEditorActionListener() {
                    @Override
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
    ...
    public void _SetupUI() {
        ...
        CreateButton.setOnApplyWindowInsetsListener(
                new View.OnApplyWindowInsetsListener() {
                    ...
                    public WindowInsets onApplyWindowInsets(View v, WindowInsets insets) {
                        ...
                        ViewGroup.MarginLayoutParams params =
                                (ViewGroup.MarginLayoutParams) CreateButton.getLayoutParams();
        ...
        _app_bar.setPadding(
                _app_bar.getPaddingLeft(),
                _app_bar.getPaddingTop() + statusBarHeight,
                _app_bar.getPaddingRight(),
                _app_bar.getPaddingBottom());
        AliasTIP.setBoxCornerRadii(
                (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15));
        AliasPassTIP.setBoxCornerRadii(
                (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15));
        KeyStorePassTIP.setBoxCornerRadii(
                (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15));
        KeyTypeTIP.setBoxCornerRadii(
                (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15));
        KeySizeTIP.setBoxCornerRadii(
                (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15));
        KeyValidityTIP.setBoxCornerRadii(
                (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15));
        NameTIP.setBoxCornerRadii(
                (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15));
        OrNameTIP.setBoxCornerRadii(
                (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15));
        OrUnitTIP.setBoxCornerRadii(
                (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15));
        CityTIP.setBoxCornerRadii(
                (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15));
        StateTIP.setBoxCornerRadii(
                (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15));
        CountryTIP.setBoxCornerRadii(
                (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15), (float) _DpToPx(15));
        TopTitle.setPadding(
                TopTitle.getPaddingLeft(),
                TopTitle.getPaddingTop() + statusBarHeight,
                TopTitle.getPaddingRight(),
                TopTitle.getPaddingBottom());
        Runnable runnable =
                new Runnable() {
                    @Override
                    public void run() {
                        if (CreateButton.getHeight() != 0) {
                            _SetMargins(
                                    ...
                                    0,
                                    0,
                                    CreateButton.getHeight() + navigationBarHeight);
                        } else {
    ...
    public void _CreateSigningKey(
            final String _type,
            final String _path,
            final String _keystorepass,
            final String _alias,
            final String _aliaspass,
            final String _dn,
            final int _validity,
            final int _keysize) {
        try {
            KeyUtils.createKeyStore(
                    _type, _path, _keystorepass, _alias, _aliaspass, _dn, _validity, _keysize);
        } catch (Exception e) {
