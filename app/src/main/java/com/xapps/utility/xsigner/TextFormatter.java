...
public class TextFormatter {
    ...
    public static SpannableStringBuilder formatText(
            String input, String partToFormat, String style) {
    ...
    public static SpannableStringBuilder formatText(
            String input, String partToFormat, String style, int color) {
        SpannableStringBuilder formattedText = new SpannableStringBuilder(input);
        ...
        if (partToFormat != null && style != null) {
            ...
            if (startIndex != -1) {
                ...
                if (style.startsWith("bold")) {
                    ...
                    int colorish = color;
                    formattedText.setSpan(
                            new ForegroundColorSpan(colorish),
                            startIndex,
                            endIndex,
                            Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                } else if (style.startsWith("BC")) {
    ...
    public static SpannableStringBuilder formatText(
            SpannableStringBuilder input, String partToFormat, String style, int color) {
        SpannableStringBuilder formattedText = new SpannableStringBuilder(input);
