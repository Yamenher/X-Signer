...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    public void ShowSingleButtonDialog(
            Context context, String title, String message, String buttonText, int uniqueId) {
        ...
        final TextView DTitle = (TextView) FinishDialogCV.findViewById(R.id.Title);
        final TextView DMessage = (TextView) FinishDialogCV.findViewById(R.id.Message);
        final TextView RightText = (TextView) FinishDialogCV.findViewById(R.id.RightText);
        final LinearLayout LeftButton = (LinearLayout) FinishDialogCV.findViewById(R.id.LeftButton);
        final LinearLayout RightButton =
                (LinearLayout) FinishDialogCV.findViewById(R.id.RightButton);
