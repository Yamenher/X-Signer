...
public class KeysListActivity extends AppCompatActivity {
    ...
    private void initializeLogic() {
        ...
        ObjectAnimator animator3 =
                ObjectAnimator.ofInt(binding.fab.getDrawable(), "level", 0, 10000);
        animator3.setDuration(200);
        animator3.setInterpolator(new DecelerateInterpolator());
        ObjectAnimator animator4 =
                ObjectAnimator.ofInt(binding.fab.getDrawable(), "level", 10000, 0);
                ...
                v -> {
                    if (!isMenuShown) {
                        ...
                        popupWindow.showAsDropDown(
                                binding.fab,
                                offsetX,
                                -binding.fab.getHeight() * 2 - (bottomMargin / 4) * 5);
        ...
        if (_resultCode == Activity.RESULT_OK) {
            if (_data != null) {
                if (_requestCode == 911) {
                    ...
                    Cursor returnCursor =
                            getContentResolver().query(PathUri, null, null, null, null);
                    ...
                    if (Uri.parse(LowerCasePath)
                            .getLastPathSegment()
                            .substring(
                                    (int)
                                            (Uri.parse(LowerCasePath).getLastPathSegment().length()
                                                    - ".".concat("jks").length()),
                                    (int) (Uri.parse(LowerCasePath).getLastPathSegment().length()))
                            .equals(".".concat("jks"))) {
                        IsSupportedKey = true;
                    }
                    if (!IsSupportedKey) {
                                ...
                                .substring(
                                        (int)
                                                (Uri.parse(LowerCasePath)
                                                                .getLastPathSegment()
                                                                .length()
                                                        - ".".concat("pkcs12").length()),
                                        (int)
                                                (Uri.parse(LowerCasePath)
                                                        .getLastPathSegment()
                                                        .length()))
                                .equals(".".concat("pkcs12"))) {
                            IsSupportedKey = true;
                            IsPkcs12 = true;
                        }
                    }
                    if (!IsSupportedKey) {
                        View InvalidSnackbarView =
                                getLayoutInflater().inflate(R.layout.premium_snackbar, null);
                        InvalidSnackbar =
                                com.google.android.material.snackbar.Snackbar.make(
                                        binding.Coordinator, "", Snackbar.LENGTH_LONG);
                        final LinearLayout SBG =
                                (LinearLayout) InvalidSnackbarView.findViewById(R.id.BG);
                        final TextView Message =
                                (TextView) InvalidSnackbarView.findViewById(R.id.Message);
                        final ImageView Icon =
                                (ImageView) InvalidSnackbarView.findViewById(R.id.Icon);
                        ...
                        Snackbar.SnackbarLayout InvalidSnackbarView2 =
                                (Snackbar.SnackbarLayout) InvalidSnackbar.getView();
                        ...
                        final AlertDialog KeyImportDialog =
                                new AlertDialog.Builder(KeysListActivity.this).create();
                        LayoutInflater KeyImportDialogLI = getLayoutInflater();
                        View KeyImportDialogCV =
                                KeyImportDialogLI.inflate(R.layout.key_import_dialog, null);
                        KeyImportDialog.setView(KeyImportDialogCV);
                        KeyImportDialog.getWindow()
                                .setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                        final com.google.android.material.textfield.TextInputEditText AliasE =
                                (com.google.android.material.textfield.TextInputEditText)
                                        KeyImportDialogCV.findViewById(R.id.AliasE);
                        final com.google.android.material.textfield.TextInputEditText KeyPassE =
                                (com.google.android.material.textfield.TextInputEditText)
                                        KeyImportDialogCV.findViewById(R.id.KeyPassE);
                        final com.google.android.material.textfield.TextInputEditText KeyStoreE =
                                (com.google.android.material.textfield.TextInputEditText)
                                        KeyImportDialogCV.findViewById(R.id.KeyStoreE);
                        final com.google.android.material.textfield.TextInputLayout AliasTIP =
                                (com.google.android.material.textfield.TextInputLayout)
                                        KeyImportDialogCV.findViewById(R.id.AliasTIP);
                        final com.google.android.material.textfield.TextInputLayout KeyPassTIP =
                                (com.google.android.material.textfield.TextInputLayout)
                                        KeyImportDialogCV.findViewById(R.id.KeyPassTIP);
                        final com.google.android.material.textfield.TextInputLayout KeyStoreTIP =
                                (com.google.android.material.textfield.TextInputLayout)
                                        KeyImportDialogCV.findViewById(R.id.KeyStoreTIP);
                        final LinearLayout LeftButton =
                                (LinearLayout) KeyImportDialogCV.findViewById(R.id.LeftButton);
                        final LinearLayout RightButton =
                                (LinearLayout) KeyImportDialogCV.findViewById(R.id.RightButton);
                        final TextView note = (TextView) KeyImportDialogCV.findViewById(R.id.note);
                        if (IsPkcs12) {
                            KeyPassTIP.setVisibility(View.GONE);
                        } else {
                            note.setVisibility(View.GONE);
                        }
                        AliasE.addTextChangedListener(
                                new TextWatcher() {
                                    @Override
                        ...
                        KeyStoreE.addTextChangedListener(
                                new TextWatcher() {
                                    @Override
                                    public void onTextChanged(
                                            CharSequence _param1,
                        ...
                        KeyPassE.addTextChangedListener(
                                new TextWatcher() {
                                    @Override
                                    public void onTextChanged(
                                            CharSequence _param1,
                        ...
                        KeyStoreTIP.setBoxCornerRadii(
                                (float) 25, (float) 25, (float) 25, (float) 25);
                        AliasTIP.setBoxCornerRadii((float) 25, (float) 25, (float) 25, (float) 25);
                        KeyPassTIP.setBoxCornerRadii(
                                (float) 25, (float) 25, (float) 25, (float) 25);
                        RightButton.setOnClickListener(
                                new View.OnClickListener() {
                                    ...
                                    public void onClick(View _view) {
                                        try {
                                            FileUtil.deleteFile(
                                                    "/data/data/com.xapps.utility.xsigner/error.txt");
                                        } catch (Exception e) {

                                        }
                                        final AlertDialog KeyLoadingDialog =
                                                new AlertDialog.Builder(KeysListActivity.this)
                                                        .create();
                                        LayoutInflater KeyLoadingDialogLI = getLayoutInflater();
                                        View KeyLoadingDialogCV =
                                                (View)
                                                        KeyLoadingDialogLI.inflate(
                                                                R.layout.key_loading_dialog, null);
                                        KeyLoadingDialog.setView(KeyLoadingDialogCV);
                                        final com.google.android.material.progressindicator
                                                        .CircularProgressIndicator
                                                progress =
                                                        (com.google.android.material
                                                                        .progressindicator
                                                                        .CircularProgressIndicator)
                                                                KeyLoadingDialogCV.findViewById(
                                                                        R.id.progress);
                                        progress.setIndeterminate(true);
                                        KeyLoadingDialog.getWindow()
                                                .setBackgroundDrawable(
                                                        new ColorDrawable(Color.TRANSPARENT));
                                        KeyLoadingDialog.setCancelable(false);
                                        KeyLoadingDialog.setOnDismissListener(
                                                new DialogInterface.OnDismissListener() {
                                                    ...
                                                    public void onDismiss(
                                                        ...
                                                        if (FileUtil.isExistFile(
                                                                        ...
                                                                        new Runnable() {
                                                                            ...
                                                                            public void run() {
                                                                                try {
                                                                                    FileUtil
                                                                                            .deleteFile(
                                                                                                    "/data/data/com.xapps.utility.xsigner/blank_signed.apk");
                                                                                } catch (
                                                                                        Exception
                                                                                                e) {
                                                                                ...
                                                                                || FileUtil
                                                                                        ...
                                                                                        .contains(
                                                                                                "java.io.IOException:"
                                                                                                    ...
                                                                                                    + " check"
                                                                                                    + " failed."))) {
                                                                    KeyStoreTIP.setError(
                                                                            "Incorrect KeyStore"
                                                                                + " password ");
                                                                    KeyStoreTIP.setErrorEnabled(
                                                                            true);
                                                                    KnownError = true;
                                                                }
                                                                if (FileUtil.readFile(
                                                                ...
                                                                if (FileUtil.readFile(
                                                                                ...
                                                                                .equals(
                                                                                        "java.io.FileNotFoundException:"
                                                                                            + " /data/data/com.xapps.utility.xsigner/")
                                                                        && FileUtil.readFile(
                                                                                        "/data/data/com.xapps.utility.xsigner/error.txt")
                                                                                .contains(
                                                                                        "open failed:"
                                                                    ...
                                                                    final AlertDialog
                                                                            UnhandledErrorDialog =
                                                                                    new AlertDialog
                                                                                            ...
                                                                                            .create();
                                                                    LayoutInflater
                                                                            UnhandledErrorDialogLI =
                                                                                    getLayoutInflater();
                                                                    View UnhandledErrorDialogCV =
                                                                            (View)
                                                                                    UnhandledErrorDialogLI
                                                                                            .inflate(
                                                                                                    R
                                                                                                            .layout
                                                                                                            .unhandled_error_dialog,
                                                                                                    null);
                                                                    UnhandledErrorDialog.setView(
                                                                            UnhandledErrorDialogCV);
                                                                    UnhandledErrorDialog.getWindow()
                                                                            .setBackgroundDrawable(
                                                                                    new ColorDrawable(
                                                                                            Color
                                                                                                    .TRANSPARENT));
                                                                                    ...
                                                                                    UnhandledErrorDialogCV
                                                                                            .findViewById(
                                                                                                    R
                                                                                                            .id
                                                                                                            .w);
                                                                    final LinearLayout LeftButton2 =
                                                                            (LinearLayout)
                                                                                    UnhandledErrorDialogCV
                                                                                            .findViewById(
                                                                                                    R
                                                                                    ...
                                                                                    AlertDialog
                                                                                            SimpleLoaderDialog =
                                                                                                    new AlertDialog
                                                                                                            ...
                                                                                                            .create();
                                                                                    LayoutInflater
                                                                                            SimpleLoaderDialogLI =
                                                                                                    getLayoutInflater();
                                                                                    View
                                                                                            SimpleLoaderDialogCV =
                                                                                                    (View)
                                                                                                            SimpleLoaderDialogLI
                                                                                                                    .inflate(
                                                                                                                            R
                                                                                                                                    .layout
                                                                                                                                    .simple_loader_dialog,
                                                                                                                            null);
                                                                                    SimpleLoaderDialog
                                                                                            .setView(
                                                                                                    SimpleLoaderDialogCV);
                                                            ...
                                                            KeystorePass =
                                                                    KeyStoreE.getText().toString();
                                                            AliasKey =
                                                                    KeyPassE.getText().toString();
                                                            KeyFileName = FileName;
                                                            Alias = AliasE.getText().toString();
                                                            _TryToLoadKeys();
                                                            KeyImportDialog.dismiss();
                                                                                                ...
                                                                                                .equals(
                                                                                                        "."
                                                                                                                .concat(
                                                                                                                        "jks"))) {
                                                                                            _SignWithReleaseKey(
                                                                                                    "/data/data/com.xapps.utility.xsigner/blank.apk",
                                                                                                    "/data/data/com.xapps.utility.xsigner/blank_signed.apk",
                                                                                                    dataPath
                                                                                                            + "/"
                                                                                                            + FileName,
    ...
    public void _Radius(
            final View _view,
            final double _lefttop,
            final double _righttop,
            final double _leftbottom,
            final double _rightbottom,
            final String _color) {
        android.graphics.drawable.GradientDrawable gd =
                new android.graphics.drawable.GradientDrawable();
        gd.setColor(Color.parseColor(_color));
    ...
    public void _SignWithReleaseKey(
            final String _input,
            final String _output,
            final String _keypath,
            final String _alias,
            final String _keystorepass,
            final String _keypass,
            final String _type,
            final boolean _v1,
            final boolean _v2,
            final boolean _v3,
            final boolean _v4,
            final boolean _zipalign) {
        try {
            APKSignerUtils.signFile(
                    _input,
                    _output,
                    _keypath,
                    _alias,
    ...
    public void _SignWithTestKey(
            ...
            final boolean _zipalign) {
        try {
            TestKeySigner.signWithTestkey(
                    _input, _output, _pem, _pk8, _v1, _v2, _v3, _v4, _zipalign);
        } catch (Exception e) {
            XUtil.showMessage(getApplicationContext(), e.toString());
        }
    }
    ...
    public void _ImportKeyToList() {
        ...
        if (IsPkcs12) {
            ...
            KeysMap.get((int) KeysMap.size() - 1)
                    .put(
                            "type",
                            KeyFileName.substring(
                                            (int) (KeyFileName.length() - 3),
                                            (int) (KeyFileName.length()))
                                    .toUpperCase());
        }
        KeysMap.get((int) KeysMap.size() - 1)
                .put("sha1", _getKeyHash(path, Alias, KeystorePass, "SHA-1").toUpperCase());
        KeysMap.get((int) KeysMap.size() - 1)
                .put("sha256", _getKeyHash(path, Alias, KeystorePass, "SHA-256").toUpperCase());
        KeysMap.get((int) KeysMap.size() - 1)
                .put("sha512", _getKeyHash(path, Alias, KeystorePass, "SHA-512").toUpperCase());
        KeysMap.get((int) KeysMap.size() - 1)
                .put("expiry", _GetReleaseKeyData(path, KeystorePass, "exp"));
        KeysMap.get((int) KeysMap.size() - 1).put("path", path);
        binding.recyclerview.setAdapter(new RecyclerviewAdapter(KeysMap));
        KeyManager.edit().putString("KeysData", new Gson().toJson(KeysMap)).commit();
    }

    public String _getKeyHash(
            final String _path, final String _alias, final String _password, final String _type) {
        try {
    ...
    public void _ScrollToBottom() {
        ((LinearLayoutManager) binding.recyclerview.getLayoutManager())
                .scrollToPositionWithOffset((int) KeysMap.size() - 1, (int) 20);
        IsItemDelted = false;
        IsItemAdded = false;
    }
    ...
    public void _ExtractAssets() {
            ...
            try {
                ...
                java.io.OutputStream output =
                        new java.io.FileOutputStream(
                                "/data/data/com.xapps.utility.xsigner/" + "testkey.pk8");
        ...
        if (!FileUtil.isExistFile("/data/data/com.xapps.utility.xsigner/testkey.x509.pem")) {
            try {
                ...
                java.io.OutputStream output =
                        new java.io.FileOutputStream(
                                "/data/data/com.xapps.utility.xsigner/" + "testkey.x509.pem");
                byte data[] = new byte[1024];
                while ((count = input.read(data)) > 0) {
                    output.write(data, 0, count);
                }
    ...
    public void _SetMarginsStable(final View _view, final int _top, final int _bottom) {
        ViewGroup.MarginLayoutParams layoutParams =
                (ViewGroup.MarginLayoutParams) _view.getLayoutParams();
    ...
    public void _AnimateHeight(
            final View _view, final int _start, final int _end, final long _duration) {
    ...
    public class RecyclerviewAdapter extends RecyclerView.Adapter<RecyclerviewAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder _holder, final int _position) {
            ...
            TransitionDrawable transitionDrawable =
                    (TransitionDrawable)
                            ContextCompat.getDrawable(
                                    KeyInfoLayout.getContext(), R.drawable.key_linear_animation);
            KeyInfoLayout.setBackground(transitionDrawable);
            KeyInfoLayout.setOnClickListener(
                    new View.OnClickListener() {
                        @Override
                        public void onClick(View _view) {
            ...
            ViewGroup.MarginLayoutParams lp =
                    (ViewGroup.MarginLayoutParams) KeyInfoLayout.getLayoutParams();
            int tm = lp.topMargin;
            try {
                if (_position == 0) {
                    _SetMarginsStable(KeyInfoLayout, (int) _DpToPx(35), (int) _DpToPx(9));
                    if (!FileUtil.isExistFile(KeysMap.get(_position).get("path1").toString())
                            || !FileUtil.isExistFile(
                                    KeysMap.get((int) _position).get("path2").toString())) {
                        _ExtractAssets();
                    }
                } else {
