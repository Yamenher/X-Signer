...
public class MainActivity extends BaseActivity {
    ...
    private void initialize(Bundle _savedInstanceState) {
        ...
        binding.SSPickButton.setOnClickListener(
        ...
        binding.ViewRecentsButton.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View _view) {
                        if (CanAccessStorage) {
        ...
        binding.NavView.findViewById(R.id.DrawerContainer)
                .setOnClickListener(
                        new View.OnClickListener() {
                            @Override
                            public void onClick(View _view) {}
        ...
        binding.NavView.findViewById(R.id.SettingsLinear)
                .setOnClickListener(
                        new View.OnClickListener() {
                            @Override
                            public void onClick(View _view) {
        ...
        binding.NavView.findViewById(R.id.KeysLinear)
                .setOnClickListener(
                        new View.OnClickListener() {
                            @Override
                            public void onClick(View _view) {
        ...
        binding.NavView.findViewById(R.id.FaqLinear)
                .setOnClickListener(
                        new View.OnClickListener() {
                            @Override
                            public void onClick(View _view) {
        ...
        binding.NavView.findViewById(R.id.AboutLinear)
                .setOnClickListener(
                        new View.OnClickListener() {
                            @Override
                            public void onClick(View _view) {
    ...
    private void initializeLogic() {
        ...
        if (KeysManager.contains("KeysData")) {
            KeysList =
                    new Gson()
                            .fromJson(
                                    KeysManager.getString("KeysData", ""),
                                    new TypeToken<
    ...
    public void onDestroy() {
        ...
        for (int i = 0; i < (AppDataFiles.size()); i++) {
            if (AppDataFiles.get((i)).endsWith(".apk") || AppDataFiles.get((i)).endsWith(".apk/")) {
                if (!(AppDataFiles.get((i)).endsWith("blank.apk")
                        || AppDataFiles.get((i)).endsWith("blank.apk/"))) {
    ...
    public boolean permission() {
        if (android.os.Build.VERSION.SDK_INT
                >= android.os.Build.VERSION_CODES.R) { // R is Android 11
    ...
    public String pathToUri(String _path) {
        uriFor1 =
                "content://com.android.externalstorage.documents/tree/primary%3AAndroid/document/primary%3A";
        ...
        for (int _repeat12 = 0; _repeat12 < (str.size()); _repeat12++) {
            ...
            try {
                ...
                androidx.documentfile.provider.DocumentFile dFile2 =
                        androidx.documentfile.provider.DocumentFile.fromTreeUri(
                                getApplicationContext(), mUri2);

                try {

                    androidx.documentfile.provider.DocumentFile file = dFile.findFile(fileName);
                    android.provider.DocumentsContract.deleteDocument(
                            getApplicationContext().getContentResolver(), file.getUri());

                    android.provider.DocumentsContract.deleteDocument(
                            getApplicationContext().getContentResolver(), mUri2);
    ...
    public boolean copy(java.io.File copy, String directory, Context con) {
        ...
        androidx.documentfile.provider.DocumentFile dir =
                androidx.documentfile.provider.DocumentFile.fromTreeUri(
                        getApplicationContext(), Uri.parse(pathToRealUri(directory)));
    ...
    public boolean copyFileFromUri(Context context, Uri fileUri, Uri targetUri) {
        ...
        try {
            ...
            ParcelFileDescriptor pfd =
                    getApplicationContext().getContentResolver().openFileDescriptor(targetUri, "w");
    ...
    public void _StorageAccessCheck() {
        if (CanAccessStorage) {
            ...
            if (!IsBSBeingShow) {
                final com.google.android.material.bottomsheet.BottomSheetDialog BSD =
    ...
    public void _SetupUI() {
        ...
        binding.NavView.setPadding(
                ...
                binding.NavView.getPaddingBottom());
                ...
                KeysList.get(KeysList.size() - 1)
                        .put(
                                ...
                                _getTestKeyHash(
                                        ...
                                        .toUpperCase());
                KeysList.get(KeysList.size() - 1)
                        .put("path1", "/data/data/com.xapps.utility.xsigner/testkey.x509.pem");
                KeysList.get(KeysList.size() - 1)
                        .put("path2", "/data/data/com.xapps.utility.xsigner/testkey.pk8");
                KeysList.get(KeysList.size() - 1)
                        .put(
                                "expiry",
                                _GetTestKeyExpiry(
    ...
    public void _SigningLogic() {
        try {
            if (SelectedKey == 0) {
                if (Uri.parse(LowercaseFilerPath)
                        .getLastPathSegment()
                        .substring(
                                (Uri.parse(LowercaseFilerPath).getLastPathSegment().length()
                                        - ".".concat("apk").length()),
                                (Uri.parse(LowercaseFilerPath).getLastPathSegment().length()))
                        .equals(".".concat("apk"))) {
                    _SignWithTestKey(
                ...
                if (Uri.parse(LowercaseFilerPath)
                    ...
                    if (Uri.parse(
                        ...
                        _SignWithRelease(
                                filePath,
                                OutputApk,
                                KeysList.get((int) SelectedKey).get("path").toString(),
                                KeysList.get((int) SelectedKey).get("alias").toString(),
                                KeysList.get((int) SelectedKey).get("keystorepass").toString(),
                                KeysList.get((int) SelectedKey).get("keypass").toString(),
                                "JKS",
                                true,
                                true,
                                true,
                ...
                } else if (Uri.parse(LowercaseFilerPath)
                        .getLastPathSegment()
                        .substring(
                                (Uri.parse(LowercaseFilerPath).getLastPathSegment().length()
                                        - ".".concat("aab").length()),
    ...
    public void _QuickSigningLogic() {
        ...
        if (LowercaseFilerPath.endsWith(".apk") || LowercaseFilerPath.endsWith(".aab")) {
            ...
            final android.app.AlertDialog FileCopyingDialog =
                    new android.app.AlertDialog.Builder(MainActivity.this).create();
            LayoutInflater FileCopyingDialogLI = getLayoutInflater();
            View FileCopyingDialogCV =
                    FileCopyingDialogLI.inflate(R.layout.file_signing_progress, null);
            ...
            FileCopyingDialog.getWindow()
                    .setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
            final TextView Text = (TextView) FileCopyingDialogCV.findViewById(R.id.Text);
                                    ...
                                    new Runnable() {
                                        ...
                                        public void run() {
                                            if (FileUtil.isExistFile(filePath)) {
                                                ...
                                                String copy_file_size =
                                                        String.valueOf(file.length());
                                                progress.setProgressCompat(
                                                        (int) Double.parseDouble(copy_file_size),
                                                        true);
                                            } else {
                                                                ...
                                                                runOnUiThread(
                                                                        new Runnable() {
                                                                            ...
                                                                            public void run() {
                                                                                ...
                                                                                if (!IsShownOnce) {
                                                                                    KeySelectDialogFragmentActivityN =
                                                                                            new KeySelectDialogFragmentActivity();
                                                                                    KeySelectDialogFragmentActivityN
                                                                                            .setCancelable(
                                                                                                    false);
                                                                                    KeySelectDialogFragmentActivityN
    ...
    public void maybeRestart() {
        SharedPreferences sharedPreferences =
                getSharedPreferences("XSignerAppPrefs", Context.MODE_PRIVATE);
                            ...
                            new Runnable() {
                                ...
                                public void run() {
                                    ShowSingleButtonDialog(
                                            context,
                                            "Restart required",
                                            "Data fetching done, the app needs to restart to apply"
                                                + " some changes",
                                            "Restart",
                                            19);
