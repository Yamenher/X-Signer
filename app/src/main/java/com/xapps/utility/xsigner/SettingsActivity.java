...
public class SettingsActivity extends PrefsActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.themeChoiceLinear.setOnClickListener(
                v -> {
                    showThemeBottomSheet();
                });
        binding.dynamicColorsSwitch.setChecked(getDynamicColorsState());
        binding.dynamicColorsLinear.setOnClickListener(
                v -> {
                    binding.dynamicColorsSwitch.setChecked(
                            !binding.dynamicColorsSwitch.isChecked());
                    ...
                    Snackbar restartSnack =
                            Snackbar.make(binding.coordinator, "", Snackbar.LENGTH_LONG);
                    final LinearLayout SBG = (LinearLayout) snackView.findViewById(R.id.BG);
                    final TextView Message = (TextView) snackView.findViewById(R.id.Message);
                    final ImageView Icon = (ImageView) snackView.findViewById(R.id.Icon);
                    ...
                    Snackbar.SnackbarLayout snack =
                            (Snackbar.SnackbarLayout) restartSnack.getView();
    ...
    public void showThemeBottomSheet() {
        ...
        bs.findViewById(R.id.auto_mode_linear)
                .setOnClickListener(
                        v2 -> {
